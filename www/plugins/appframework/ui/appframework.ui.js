...
(function($) {
    ...
    var ui = function() {
        ...
        window.addEventListener("popstate", function() {
            ...
            var id = that.getPanelId(decodeURIComponent(document.location.hash));
    ...
    ui.prototype = {
        ...
        getPanelId: function(hash) {
            hash = (hash.indexOf("#/") == 0) ? hash.replace(/#\//,'#'): hash;
            var firstQuestion = hash.indexOf("?") ;
            hash =  ( firstQuestion == -1) ? hash: hash.substring(0, firstQuestion)
